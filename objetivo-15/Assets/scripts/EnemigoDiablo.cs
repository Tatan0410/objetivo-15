...
public class EnemigoDiablo : MonoBehaviour
{
    ...
    void Disparar()
    {
        ...
        {
            Debug.LogWarning("prefabProyectil no asignado en EnemigoDiablo (" + gameObject.name + ")");
            return;
        }
        ...
        ProyectilEnemigo p = proy.GetComponent<ProyectilEnemigo>();
        if (p != null)
        {
    ...
    void SoltarPlasticos()
    {
        ...
        GameObject runner = new GameObject("PlasticoSpawnRunnerDiablo");
